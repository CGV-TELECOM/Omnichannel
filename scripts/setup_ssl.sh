...
NGINX_CONF="/usr/local/contact-center/nginx/devomi.telesip.vn.conf"
...
# Copy cấu hình Nginx tạm thời (chưa có SSL) để certbot có thể validate
...
# Kiểm tra domain có trỏ về server chưa
